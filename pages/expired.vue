    ...
    <div>
        ...
        <b-table class="mt-4" responsive :items="items" :fields="fields" :per-page="perPage"
            ...
            <b-button-group vertical>
                ...
                <NuxtLink to="/detail"><b-button variant="primary">Detail</b-button></NuxtLink>
                <b-button v-b-modal.modal-4 variant="danger">Delete</b-button>
            </b-button-group>
            </template>
            </b-table>
...
export default {
    ...
    data() {
        return {
            ...
            currentPage: 1,
            items: [
                { No: '1', Invoice: '16631482221919330716995', OrderID: '16995', Customer: 'Mala', Shippingname: 'static static', Status: 'Expired', Total: 'Rp.12.000', TanggalOrder: '15/09/2022', SumberMall: 'ELIB-EurekaBookhouse' },
                { No: '2', Invoice: '16631482511911530716995', OrderID: '16905', Customer: 'Masya', Shippingname: 'static static', Status: 'Expired', Total: 'Rp.15.000', TanggalOrder: '10/09/2022', SumberMall: 'ELIB-EurekaBookhouse' }],
